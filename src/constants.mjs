export const TRANSLATIONS = {
  en: {
    'modal.info': 'Thanks for purchasing Kirby Content Translator! Please enter your email address and order ID to activate your license.',
  ...
  de: {
    'modal.info': 'Dankeschön für den Kauf vom Kirby Content Translator! Bitte gib deine E-Mail-Adresse und Bestellnummer ein, um deine Lizenz zu aktivieren.',
  ...
  fr: {
    'modal.info': 'Merci d\'avoir acheté Kirby Content Translator ! Veuillez saisir votre adresse e-mail et votre numéro de commande pour activer votre licence.',
