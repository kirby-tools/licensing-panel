...
export const TRANSLATIONS: Record<Locale, Messages> = {
  en: {
    ...
    'modal.error.upgradeable.licenseKey': 'License key invalid for this plugin version. Please upgrade your license on hub.kirby.tools.',
  ...
  de: {
    ...
    'modal.error.upgradeable.licenseKey': 'Lizenzschlüssel ungültig für diese Plugin-Version. Bitte aktualisiere deine Lizenz auf hub.kirby.tools.',
  ...
  nl: {
    ...
    'modal.error.incompatible.licenseKey': 'Licentiesleutel ongeldig voor deze plug-inversie',
    'modal.error.upgradeable.licenseKey': 'Licentiesleutel ongeldig voor deze plug-inversie. Werk je licentie bij op hub.kirby.tools.',
  ...
  fr: {
    ...
    'modal.error.upgradeable.licenseKey': 'Clé de licence invalide pour cette version du plugin. Veuillez mettre à jour votre licence sur hub.kirby.tools.',
